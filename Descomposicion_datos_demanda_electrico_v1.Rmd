...
Demanda_electrico_ts_decompose 
```
...
```{r}
Demanda_electrico_ts_decompose$seasonal
```

```{r}
Demanda_electrico_ts_sin_seasonality <-Demanda_electrico_ts - Demanda_electrico_ts_decompose$seasonal
Demanda_electrico_ts_sin_seasonality
```


```{r}
plot(Demanda_electrico_ts_sin_seasonality)
```
